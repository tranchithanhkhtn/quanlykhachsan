...
namespace QuanLyKhachSan.DTO
{
    ...
    {
        public RoomManager(string maphong, string loaiphong, int dongia, string tinhtrang, string thongtin, byte[] hinh1, byte[] hinh2, byte[] hinh3, byte[] hinh4)
        {
        ...
        public RoomManager(DataRow row)
        {
